 ...
 * @author ankus
 */
public class resultbtechcse extends javax.swing.JFrame {

    /**
     * Creates new form resultbtechcse
     */
    public resultbtechcse() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT CSE RESULT");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select * from resultcse");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultbtechcse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
