...
public class mtech extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String datastructurec= jTextField5.getText();
        ...
        try{
            ...
            //checking if the roll no already present aat student table and store in result mtech
            ResultSet rs=st.executeQuery("select * from student where rollno='"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into resultmtech(rollno,enggmathematics1,basicelectronics,appliedchemistry,enggphysics,datastructurec) values('"+rollno+"', '"+enggmathematics1+"', '"+basicelectronics+"', '"+appliedchemistry+"', '"+enggphysics+"', '"+datastructurec+"' )");
