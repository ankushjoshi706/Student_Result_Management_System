...
public class btechcse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Electrical Technology");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Probability and Statistics");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String computerorganization = jTextField1.getText();
        String electricaltechnology = jTextField2.getText();
        String probabilityandstatistics = jTextField3.getText();
        String operatingsystem = jTextField4.getText();
        String objectorientedprogramming= jTextField5.getText();
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into resultcse(rollno,computerorganization,electricaltechnology,probabilityandstatistics,operatingsystem,objectorientedprogramming) values('"+rollno+"', '"+computerorganization+"', '"+electricaltechnology+"', '"+probabilityandstatistics+"', '"+operatingsystem+"', '"+objectorientedprogramming+"' )");
