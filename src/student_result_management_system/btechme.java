 ...
 * @author ankus
 */
public class btechme extends javax.swing.JFrame {

    /**
     * Creates new form btechme
     */
    public btechme() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, 580, 490));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String enggmathematic1 = jTextField1.getText();
        ...
        try{
            ...
            //checking if the roll no already present aat student table and store in result me
            ResultSet rs=st.executeQuery("select * from student where rollno='"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into resultme(rollno,enggmathematic1,basicelectronics,appliedchemistry,enggphysics,enggdrawing) values('"+rollno+"', '"+enggmathematic1+"', '"+basicelectronics+"', '"+appliedchemistry+"', '"+enggphysics+"', '"+enggdrawing+"' )");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(btechme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
