...
public class bba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Financial Accounting");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Micro Economics ");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Principles of Management ");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Quantitative Techniques ");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Business Analytics  ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String financial_accounting = jTextField1.getText();
        String micro_economics = jTextField2.getText();
        String principles_of_management = jTextField3.getText();
        String Quantitative_techniques = jTextField4.getText();
        String business_analytics= jTextField5.getText();
        ...
        try{
            ...
            //checking if the roll no already present aat student table and store in result bba
            ResultSet rs=st.executeQuery("select * from student where rollno='"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into resultbba(rollno,financial_accounting,micro_economics,principles_of_management,Quantitative_techniques,business_analytics) values('"+rollno+"', '"+financial_accounting+"', '"+micro_economics+"', '"+principles_of_management+"', '"+Quantitative_techniques+"', '"+business_analytics+"' )");
