 ...
 * @author ankus
 */
public class resultmtech extends javax.swing.JFrame {

    /**
     * Creates new form resultmtech
     */
    public resultmtech() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT M.TECH RESULT");
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, -1, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select * from resultmtech");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultmtech.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
