...
public class bca extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Foundational maths");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Creative English ");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Digital computer fundamentals ");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Quantitative Techniques ");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Operating systems ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String foundational_math = jTextField1.getText();
        String creative_english = jTextField2.getText();
        String digital_computer_fundamentals = jTextField3.getText();
        String Quantitative_techniques = jTextField4.getText();
        String operating_system= jTextField5.getText();
        ...
        try{
            ...
            //checking if the roll no already present aat student table and store in result bca
            ResultSet rs=st.executeQuery("select * from student where rollno='"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into resultbca(rollno,foundational_math,creative_english,digital_computer_fundamentals,Quantitative_techniques,operating_system) values('"+rollno+"', '"+foundational_math+"', '"+creative_english+"', '"+digital_computer_fundamentals+"', '"+Quantitative_techniques+"', '"+operating_system+"' )");
