...
public class btechit extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String computerorgg = jTextField1.getText();
        String electricaltech = jTextField2.getText();
        String probabilityandstatistics = jTextField3.getText();
        String operatingsystem = jTextField4.getText();
        String objectorientedprogg= jTextField5.getText();
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into resultit(rollno,computerorgg,electricaltech,probabilityandstatistics,operatingsystem,objectorientedprogg) values('"+rollno+"', '"+computerorgg+"', '"+electricaltech+"', '"+probabilityandstatistics+"', '"+operatingsystem+"', '"+objectorientedprogg+"' )");
