 ...
 * @author ankus
 */
public class resultbtechit extends javax.swing.JFrame {

    /**
     * Creates new form resultbtechit
     */
    public resultbtechit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT IT RESULT");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select * from resultit");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultbtechit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
