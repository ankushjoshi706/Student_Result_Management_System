 ...
 * @author ankus
 */
public class studentresultme extends javax.swing.JFrame {

    /**
     * Creates new form studentresultme
     */
    public studentresultme() {
        initComponents();
    }
    public studentresultme(String rollno) {
        initComponents();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultme where student.rollno='"+rollno+"' and resultme.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultme().setVisible(true);
            }
        });
    }
