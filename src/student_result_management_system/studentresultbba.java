 ...
 * @author ankus
 */
public class studentresultbba extends javax.swing.JFrame {

    /**
     * Creates new form studentresultbba
     */
    public studentresultbba() {
        initComponents();
    }
    public studentresultbba(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Micro Economics");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setText("Principles of Management");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel10.setText("Quantitative Technique");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setText("Bussiness Analytics");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultbba where student.rollno='"+rollno+"' and resultbba.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultbba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultbba().setVisible(true);
            }
        });
    }
