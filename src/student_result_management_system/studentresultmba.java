 ...
 * @author ankus
 */
public class studentresultmba extends javax.swing.JFrame {

    /**
     * Creates new form studentresultmba
     */
    public studentresultmba() {
        initComponents();
    }
    public studentresultmba(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Organizational Behaviour");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("Quantitative Methods");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setText("Managerial Economics");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel10.setText("Quantitative Technique");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setText("Financial Accounting");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultmba where student.rollno='"+rollno+"' and resultmba.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultmba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultmba().setVisible(true);
            }
        });
    }
