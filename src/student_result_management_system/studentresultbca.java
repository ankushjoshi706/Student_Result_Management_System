 ...
 * @author ankus
 */
public class studentresultbca extends javax.swing.JFrame {

    /**
     * Creates new form studentresultbca
     */
    public studentresultbca() {
        initComponents();
    }
     public studentresultbca(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Foundational Maths");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("Creative English");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setText("Digital Computer ");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultbca where student.rollno='"+rollno+"' and resultbca.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultbca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultbca().setVisible(true);
            }
        });
    }
