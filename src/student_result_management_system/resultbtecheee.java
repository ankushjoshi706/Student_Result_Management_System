 ...
 * @author ankus
 */
public class resultbtecheee extends javax.swing.JFrame {

    /**
     * Creates new form resultbtecheee
     */
    public resultbtecheee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT EEE RESULT");
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 580, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select * from resulteee");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultbtecheee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
