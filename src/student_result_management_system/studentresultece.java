 ...
 * @author ankus
 */
public class studentresultece extends javax.swing.JFrame {

    /**
     * Creates new form studentresultece
     */
    public studentresultece() {
        initComponents();
    }
     public studentresultece(String rollno) {
        initComponents();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultece where student.rollno='"+rollno+"' and resultece.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultece.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultece().setVisible(true);
            }
        });
    }
