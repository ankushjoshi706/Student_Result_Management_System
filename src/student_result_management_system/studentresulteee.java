 ...
 * @author ankus
 */
public class studentresulteee extends javax.swing.JFrame {

    /**
     * Creates new form studentresulteee
     */
    public studentresulteee() {
        initComponents();
    }
    public studentresulteee(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(213, 255, 153));
        ...
        jLabel7.setText("Engineering Physics");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("Engineering Chemistry");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setText("Programming");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel10.setText("Electrical Instrument");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setText("Engineering Mechanics");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resulteee where student.rollno='"+rollno+"' and resulteee.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresulteee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresulteee().setVisible(true);
            }
        });
    }
