 ...
 * @author ankus
 */
public class resultbca extends javax.swing.JFrame {

    /**
     * Creates new form resultbca
     */
    public resultbca() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT MBA RESULT");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select * from resultbca");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultbca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
