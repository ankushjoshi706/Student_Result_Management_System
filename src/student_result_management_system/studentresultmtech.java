 ...
 * @author ankus
 */
public class studentresultmtech extends javax.swing.JFrame {

    /**
     * Creates new form studentresultmtech
     */
    public studentresultmtech() {
        initComponents();
    }
    public studentresultmtech(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Engineering Mathematics-1");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("Basic Electronics");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setText("Applied Chemistry");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel10.setText("Engineering Physics");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setText("Datastructure in C");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_management_system/back.png"))); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultmtech where student.rollno='"+rollno+"' and resultmtech.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultmtech.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultmtech().setVisible(true);
            }
        });
    }
