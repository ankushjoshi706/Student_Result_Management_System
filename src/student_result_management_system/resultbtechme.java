 ...
 * @author ankus
 */
public class resultbtechme extends javax.swing.JFrame {

    /**
     * Creates new form resultbtechme
     */
    public resultbtechme() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ALL STUDENT ME RESULT");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 67, 580, 420));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultbtechme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultbtechme().setVisible(true);
            }
        });
    }
