 ...
 * @author ankus
 */
public class studentresultcse extends javax.swing.JFrame {

    /**
     * Creates new form studentresultcse
     */
    public studentresultcse() {
        initComponents();
    }
     public studentresultcse(String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Computer Organization");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("Electrical Technology");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            //checking if roll no is present or not
             ResultSet rs=st.executeQuery("select * from student inner join resultcse where student.rollno='"+rollno+"' and resultcse.rollno='"+rollno+"'");
             if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentresultcse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentresultcse().setVisible(true);
            }
        });
    }
